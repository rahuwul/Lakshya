  ...
  return (
    <div className='py-20 flex justify-center w-full  '>
      <div className='w-[50rem]'>
        ...
        <div className='' >
          <h1 id='abouttext' className='text-right'>Lakshya started as a project during a hackathon, where I took the lead in crafting the entire frontend experience from scratch. From whipping up designs in Figma to coding them into a proper webpage with <b>ReactJS</b> and <b>TailwindCSS</b>, it was a fun! In this project, I fine-tuned my frontend skills and tackled everything from React Hooks to the fine art of centering a div using Tailwind :D . Looking forward to design more! </h1>
          </div>
          <div className='flex justify-end py-2 '>
        ...
        <div id='linkbox' className='flex flex-row  justify-center border-black border-2 w-[9.5rem] rounded-lg bg-[#9525e8]'>
